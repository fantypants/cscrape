defmodule CryptscrapeWeb.SessionControllerTest do
  use CryptscrapeWeb.ConnCase

  import CryptscrapeWeb.AuthCase
  ...
  setup %{conn: conn} do
    conn = conn |> bypass_through(CryptscrapeWeb.Router, [:browser]) |> get("/")
